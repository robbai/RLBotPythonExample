...
class Learner(BaseAgent):
    ...
    def initialize_agent(self):
        ...
        jump_weight = 8
        self.model.compile(optimizer = tf.compat.v1.train.AdamOptimizer(0.0005), loss = ['mse', 'mse', 'mse'], loss_weights=[1, 1, jump_weight])
    ...
    def update_training_params(self, time: float = 0):
        self.training_steps = min(1000, max(200, time // 4))
